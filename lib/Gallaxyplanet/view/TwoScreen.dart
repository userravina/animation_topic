                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              "${controller.h1.value.distance} km",
                              style: TextStyle(
                            ...
                            Text(
                              "${controller.h1.value.gravity} m/s²",
                              style: TextStyle(
                                  color: Colors.grey, fontSize: 10.sp),
                            )
                          ],
              ...
              child: Padding(
                  ...
                  child: AnimatedBuilder(
                    ...
                    child: Container(
                      height: 15.h,
                      width: 15.h,
                      child: Image.asset("${controller.h1.value.image}"),
                    ),
                          ...
                          child: Column(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  "WELCOME TO ${controller.h1.value.name}",
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 21.sp,
                                      fontWeight: FontWeight.bold),
                              ...
                              Text(
                                "${controller.h1.value.distance_sun} km",
                                style: TextStyle(
                              ...
                              Text(
                                "${controller.h1.value.distance_earth} km",
                                style: TextStyle(
                                    color: Colors.white, fontSize: 30.sp),
                              ),
                            ],
